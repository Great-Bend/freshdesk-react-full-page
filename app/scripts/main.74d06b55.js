...
var Fullpage = function Fullpage() {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null, "Full Page App");
};
    ...
    app.initialized().then(function (client) {
      client.instance.context().then(function (data) {
        ...
        if (location === "full_page_app") {
          setChild( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Fullpage, {
            client: client
          }));
        }
      });
...
//# sourceMappingURL=main.74d06b55.js.map